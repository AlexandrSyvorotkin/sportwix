...
const defaultStyle = 'w-10 h-10 rounded-full flex items-center justify-center font-normal text-[18px] leading-[18px] border-solid'
...
const CupMedal = ({
    ...
    return (
        <div className={`${defaultStyle} ${CUP_STYLES[cupMedalType]}`}>
            {cupsCount}
        </div>
    )
}
