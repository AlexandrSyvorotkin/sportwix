...
import { useXSMAX, useSMMIN } from "../../media-queries";
import { filterChartBySeasons, filterChartByHomeOrAwayGames, filterChartByAmountOfGoals, filterChartByTypeOfTime } from "../../redux/candle-slice/candle-slice";
import { activateGuidelineMode, disableEducationOffer } from "../../redux/GuidelineRoadmapSlice/GuidelineRoadmapSlice";
import { switchVersion, switchMobileOrientation, expandTypes, expandSection } from "../../redux/InterfaceSlice/InterfaceSlice";
import TeamStatsControls from "../../redux/TeamStatsControls/TeamStatsControls";
import { switchActiveTeamDetailInfoTabMobile } from "../../redux/TeamTabsSlice/TeamTabsSlice";
import { chooseSecondTeam, switchPageToStartPostition, setFirstSelectedTeamUuid, setCurrentSeasonsAmount, setSpliteType } from "../../redux/tournament-slice/tournament-slice";
import { useFetchChampionshipInfoQuery } from "../../services/championships-api/championship-api";
import { filterByHomeAwayGamesVariants, filterByAmountOfGoalsVarians, filterByTypeOfTimeVariants } from "../../types/candleChartFilterTypes";
