		...
		<div className="w-full h-full flex justify-center p-[10px]">
			<div className="flex flex-col gap-[10px] items-center justify-center">
				...
				<div className="w-3 h-full rounded-xl bg-[#181818] border border-[#5C5C5C] relative">
					<div className="absolute rounded-xl w-5 left-[-5px] h-[5px] bg-[#A266F4] cursor-pointer" style={{ bottom: `${firstSelectedTeamForceIndex}%` }}>
						...
						<span className="text-xs absolute left-[23px] top-[-3px]">{firstSelectedTeamForceIndex?.toFixed(1)}</span>
					</div>
					{secondTeamImg && <div className="absolute rounded-xl w-5 left-[-5px] h-[5px] bg-[#DC7700]" style={{ bottom: `${secondTeamForceIndex}%` }}>
						...
						<span className="text-xs absolute left-[-33px] top-[-3px]">{secondTeamForceIndex?.toFixed(1)}</span>
					</div>}
