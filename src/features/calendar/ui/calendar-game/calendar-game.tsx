...
const CalendarGame = ({
    ...
    const goalsSelectedTeam = goals_selected && goals_selected.map((goal: Goal, i: number) => {
        return (
            <CalendarGameGoal key={i} type='selected-team' goal_player={goal.player} goal_minute={goal.munite} player_img={goal.player_img} />
        )
    })


    const goalsVersusTeam = goals_versus && goals_versus.map((goal: Goal, i: number) =>
        <CalendarGameGoal key={i} type='versus-team' goal_player={goal.player} goal_minute={goal.munite} player_img={goal.player_img} />
