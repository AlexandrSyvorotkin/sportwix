...
export function CalendarOddsBar({ team_target_odds_procents, team_opponent_odds_procents, draw_odds_procents }: CalendarOddsBarProps) {
    ...
    return (
        <div className="min-h-[35%] flex flex-col">
            <div className="bg-[#469A1F] w-3 rounded-t-[5px]" style={{ height: `${team_target_odds_procents}%`, display: greenDisplay }}></div>
            <div className="bg-[#B7A503] w-3" style={{
                height: `${yellowHeight}%`,
            ...
            <div className="bg-[#ED392F] w-3 rounded-b-[5px]" style={{ height: `${team_opponent_odds_procents}%`, display: redDisplay }}></div>
        </div>
    )
}