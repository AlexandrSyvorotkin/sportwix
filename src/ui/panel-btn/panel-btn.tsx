import { Tooltip, TooltipArrow, TooltipContent, TooltipProvider, TooltipTrigger } from '@shared/tooltip';
    ...
    return (
        <TooltipProvider>
            <Tooltip>
                ...
                {tooltipText && <TooltipContent side={tooltipSide} className='text-[#1F1F1F]'>
