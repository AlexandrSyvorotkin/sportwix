...
const QUESTIONS = [
  {
    ...
    answer:
      'Для регистрации в приложении, вам нужно будет ввести свой номер телефона и подтвердить его.',
  },
  {
    id: 1,
    question: 'Как создать аккаунт? Как восстановить пароль?',
  ...
  return (
    <Container>
      <div className="mt-[120px] pb-[120px] flex flex-col gap-4 justify-center items-center w-full">
        <h2 className="xl:text-[57px] lg:text-[40px] md:text-[32px] sm:text-[24px] text-center mb-[52px]">
