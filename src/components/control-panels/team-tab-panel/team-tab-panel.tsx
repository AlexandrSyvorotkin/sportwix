...
const TeamTabPanel = () => {
  ...
  const activeTeamDetailInfoTab = useAppSelector(
    (state: RootState) => state.interfaceState.team_tabs.active_team_tab
  )

  const isAnyTeamSelected = useAppSelector(
    ...
    () => [
      {
        icon: (
          <NewsIcon
            className={activeTeamDetailInfoTab === 'news' ? 'text-[#A266F4]' : 'text-[#FFFFFF]'}
          />
        ),
      ...
      },
      {
        icon: (
          <AboutTeamIcon
            className={
              activeTeamDetailInfoTab === 'about-team' ? 'text-[#A266F4]' : 'text-[#FFFFFF]'
            }
          />
        ),
      ...
      {
        icon: (
          <ChampionshipsPerformanceIcon
            className={
              activeTeamDetailInfoTab === 'championships-performance'
                ? 'text-[#A266F4]'
                : 'text-[#FFFFFF]'
            }
          />
      ...
      },
      {
        icon: (
          <TeamStatsIcon
            className={
              activeTeamDetailInfoTab === 'team-stats' ? 'text-[#A266F4]' : 'text-[#FFFFFF]'
            }
          />
        ),
      ...
      {
        icon: (
          <PlayerStatIcon fill={activeTeamDetailInfoTab === 'player-stat' ? activeColor : ''} />
        ),
      ...
      },
      {
        icon: (
          <CalendarIcon
            className={activeTeamDetailInfoTab === 'calendar' ? 'text-[#A266F4]' : 'text-[#FFFFFF]'}
          />
        ),
