        ...
        <div className='flex flex-col'>
            ...
            {club_records?.longest_unbeaten_streak?.map((record, id: number) => 
                <div className='flex flex-col'>
                        ...
                        <span className="flex w-1/3 justify-center items-center">{record.value} {language === 'Eng' ? 'games' : 'Игр'}</span>
                        <div className='flex w-2/3 h-[50px]'>
                            <span className="p-[10px] h-[50px] flex justify-center items-center w-1/2">{record.league}</span>
                            <span className="p-[10px] h-[50px] flex justify-center items-center w-1/2">{record.period}</span>
                        </div>
                    </div>
                    <Separator className="w-full h-[1px]"/>
                </div>
            ...
            {club_records?.treble?.map((record, id: number) => 
                <div className='flex flex-col'>
                    <div key={id} className='w-full flex justify-center items-center'>
                        <span className="p-[10px] h-[50px] flex justify-center items-center w-1/3">{record.value} {language === 'Eng' ? 'games' : 'Игр'}</span>
