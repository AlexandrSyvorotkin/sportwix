...
const SingleCupTeamAchievement = ({
  coeff_games,
  count_games,
  league_name,
  gold_of_league,
  ...
  return (
    <div className={singleCupAchievementStyles}>
      <div className={styles.cup_description}>
        ...
        <p className={styles.cup_title} style={{ color: textColor }}>
          {league_name}
        </p>
      </div>
      ...
      <div className={styles.metrics}>
        <div className={styles.metric_item} style={{ color: textColor }}>
          <div className={styles.metric_type}>
            {language === 'Eng' ? 'Total games' : 'Всего игр'}
          </div>
          <div className={styles.games} style={{ color: textColor }}>
            {count_games}
          </div>
        </div>
        <div className={styles.metric_item} style={{ color: textColor }}>
          <div className={styles.metric_type}>
            {language === 'Eng' ? 'Prizes coefficient' : 'Коефф. побед'}
          </div>
          <div className={styles.games} style={{ color: textColor }}>
            {coeff_games}
          </div>
