  ...
  return (
    <div className={styles.uniform_and_emblems}>
      <div className={styles.uniforms}>
        <KitItem
          uniform_img={homeKit}
          uniform_type={language === 'Eng' ? 'Home kit' : 'Домашняя форма'}
        />
        <KitItem
          uniform_img={awayKit}
          uniform_type={language === 'Eng' ? 'Away kit' : 'Гостевая форма'}
        />
        <KitItem
          uniform_img={altKit}
          uniform_type={language === 'Eng' ? 'Reserve kit' : 'Резервная форма'}
        />
      </div>
      <div className={styles.club_description}>
        ...
        <p className={styles.text} style={{ color: textColor }}>
          {language === 'Eng'
            ? firstTeamSelected?.tabs?.form?.design_info
            : firstTeamSelected?.tabs?.form?.design_info_ru}
        </p>
      </div>
    </div>
  )
