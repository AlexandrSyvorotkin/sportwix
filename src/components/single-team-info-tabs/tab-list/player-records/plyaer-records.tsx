...
const PlayersRecords = () => {
  const teamPlayerRecords = useAppSelector(
    (state: RootState) => state.tournamentSlice.firstSelectedTeam?.tabs.players_records
  )
  const language = 'Eng'
    ...
    <div className="flex flex-col overflow-auto h-full">
      <div className="flex flex-col">
        <div className="flex justify-center items-center p-[10px]">
          {'Наибольшее количество забитых голов'}
        </div>
        <Separator className="w-full h-[1px]" />
      </div>
      <div className="flex justify-between w-full">
        <span className="w-1/5 p-[10px] flex justify-center items-center">
          {language === 'Eng' ? player_records.name.eng : player_records.name.ru}
        </span>
        <span className="w-1/5 p-[10px] flex justify-center items-center">
          {language === 'Eng' ? player_records.games.eng : player_records.games.ru}
        </span>
        <span className="w-1/5 p-[10px] flex justify-center items-center">
          {language === 'Eng' ? player_records.goals.eng : player_records.goals.ru}
        </span>
        <span className="w-1/5 p-[10px] flex justify-center items-center">
          {language === 'Eng' ? player_records.goals_games.eng : player_records.goals_games.ru}
        </span>
        <span className="w-1/5 p-[10px] flex justify-center items-center">
          {language === 'Eng' ? player_records.period.eng : player_records.period.ru}
        </span>
      </div>
      <div className="">
      ...
      <div className="flex flex-col">
        <div className="flex justify-center items-center p-[10px]">
          {'Наибольшее количество ассистов'}
        </div>
        <Separator className="w-full h-[1px]" />
      </div>
      <div className="flex justify-between w-full">
      ...
      <div className="flex flex-col">
        <div className="flex justify-center items-center p-[10px]">
          {'Наибольшее количество желтых карточек'}
        </div>
        <Separator className="w-full h-[1px]" />
      </div>
      <div className="flex justify-between w-full">
      ...
      <div className="flex flex-col">
        <div className="flex justify-center items-center p-[10px]">
          {'Наибольшее количество красных карточек'}
        </div>
        <Separator className="w-full h-[1px]" />
      </div>
      <div className="flex justify-between w-full">
      ...
      <div className="flex flex-col">
        <div className="flex justify-center items-center p-[10px]">
          {'Наибольшее количество ударов в створ'}
        </div>
        <Separator className="w-full h-[1px]" />
      </div>
      <div className="flex justify-between w-full">
      ...
      <div className="flex flex-col">
        <div className="flex justify-center items-center p-[10px]">
          {'Наибольшее количество ударов вне створа'}
        </div>
        <Separator className="w-full h-[1px]" />
      </div>
      <div className="flex justify-between w-full">
      ...
      <div className="flex flex-col">
        <div className="flex justify-center items-center p-[10px]">
          {'Наибольшее количество офсайдов'}
        </div>
        <Separator className="w-full h-[1px]" />
      </div>
      <div className="flex justify-between w-full">
