...
const tabs = [
  {
    id: 1,
    engTitle: singleTeamInfoTabs.achievements.eng,
    ruTitle: singleTeamInfoTabs.achievements.ru,
  },
  ...
  {
    id: 4,
    engTitle: singleTeamInfoTabs.club_records.eng,
    ruTitle: singleTeamInfoTabs.club_records.ru,
  },
  {
    id: 5,
    engTitle: singleTeamInfoTabs.player_records.eng,
    ruTitle: singleTeamInfoTabs.player_records.ru,
  },
  ...
  return (
    <div className={tabsHeader} id="single_team-info-tabs-header">
      {tabs.map((tab: Tab) => (
        <TabBtn
          key={tab.id}
          onClick={() => activeTabHandler(tab.engTitle as singleTeamInfoTabsTypes)}
          isActive={activeSingleTeamInfoTab === tab.engTitle}
        >
