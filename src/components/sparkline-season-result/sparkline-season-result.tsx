...
const SparkLineSeasonResultBar: FC<SparkLineSeasonResultBarProps> = ({
  wins,
  draws,
  losses,
  height,
  ...
  return (
    <div className={styles.bar_wrapper} id="season-bar" style={{ padding: padding }}>
      ...
      <div className={styles.season_result_percentage} style={{ width: width }}>
        <div
          className={styles.metric_percentage}
          style={{
            height: `${height}px`,
            background: '#C00000',
        ...
        <div
          className={styles.metric_percentage}
          style={{ height: `${height}px`, background: '#B7A503', width: `${drawsPercentage}%` }}
        />
        <div
          className={styles.metric_percentage}
          style={{
